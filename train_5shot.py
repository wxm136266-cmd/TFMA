...
from image_data_get import SAC_4way_image , create_set,create_set_test,SAC_4way_image_imbalance
...
parser.add_argument('--dataset', default='SAC', help='Dataset (Only CWRU or PDB)')
